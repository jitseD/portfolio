    ...
    return (
        <svg className="cursor" width="50" height="50" viewBox="0 0 50 50">
            ...
            <path
                ...
                d="M24.9997 11L38.9993 24.9996M38.9993 24.9996L25 39M38.9993 24.9996L11 24.9997"
                stroke="#F2F2F2"
            />
            <path
                className="cursor__back"
                d="M24.9996 11L11 24.9996M11 24.9996L24.9993 39M11 24.9996L38.9993 24.9997"
                stroke="#F2F2F2"
            />
            <path
                className="cursor__send"
                d="M41.0002 25.0003L13.0002 12.5L19.9999 25M41.0002 25.0003L19.9999 25M41.0002 25.0003L13 37.5L19.9999 25"
                stroke="#0D0D0D"
            />
            <path
                className="cursor__external"
