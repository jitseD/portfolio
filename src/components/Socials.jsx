    ...
    return(
        <ul className="socials">
            <li className="social__item">
                <a className="social__link hover--circle" href="https://www.instagram.com/dekeyser_designs/" target="_blank">
            ...
            <li className="social__item">
                <a className="social__link hover--circle" href="https://www.linkedin.com/in/jitse-dekeyser-92977529b/" target="_blank">
