...
const ProjectDetail = () => {
    ...
    const prevProject =
        projectsData.projects[projectIndex - 1] ||
        projectsData.projects[projectsData.projects.length - 1];
    const nextProject =
        projectsData.projects[projectIndex + 1] || projectsData.projects[0];
        ...
        <main className="main main--detail">
            <Link className="detail__nav hover--back" to={from}>
                <svg width="10" height="17" viewBox="0 0 10 17" fill="none">
                    <path
                        d="M8.99976 0.5L0.999979 8.49978L8.99958 16.5"
                        stroke="#F2F2F2"
                    />
                </svg>
                <p>go back</p>
            ...
            <section className="info">
                <div className="detail__imgs stacked__imgs">
                    <Media
                        className="detail__img detail__img--cover"
                        media={media.cover}
                    />
                    <Media
                        className="detail__img detail__img--overview"
                ...
                {project.url && (
                    <a
                        className="detail__website button hover--external"
                        href={project.url}
                        target="_blank"
                    >
                        <p>view project</p>
                    ...
                    <div className="url__wrapper">
                        ...
                        <ul className="url__list">
                            {project.moreUrls.map((moreUrl, index) => (
                                <li
                                    className="url__item hover--external"
                                    key={index}
                                >
                                    <a
                                        className="button"
            ...
            <section className="more">
                ...
                <ul className="more__projects">
                    <li className="more__project">
                        ...
                        >
                            <Media
                                className="more__img more__img--cover"
                                media={prevMedia.cover}
                            />
                            <Media
                                className="more__img more__img--overview"
                                media={prevMedia.overview}
                            />
                        </Link>
                    </li>
                    <li className="more__project">
                        ...
                        >
                            <Media
                                className="more__img more__img--cover"
                                media={nextMedia.cover}
                            />
                            <Media
                                className="more__img more__img--overview"
                                media={nextMedia.overview}
                            />
                        </Link>
                    </li>
                </ul>
