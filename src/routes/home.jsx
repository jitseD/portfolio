        ...
        <main className="main main--home">
            <section className="header">
                <h1 className="header__title">
                    <span className="title__section title--wrapped">
                        Digital <span className="emph">Designer</span>
                    </span>
                    <span className="visually-hidden">and</span>
                    <span className="title__section title--wrapped">
                        Creative <span className="emph">Developer</span>
                    </span>
                </h1>
            ...
            <section className="recent">
                <h2 className="recent__title title--wrapped">
                    Recent <span className="emph">Works</span>
                </h2>
                    ...
                    {highlightedProjects ? (
                        highlightedProjects.map((project, index) => (
                            <ProjectItem
                                ...
                                project={project}
                                index={index}
                                totalProjects={highlightedProjects.length}
                            />
                        ))
                    ) : (
